...
export default App = () => {
	...
	const calculateTax = () => {
		...
		if (incomeAmount <= 10000000){
			...
			taxAmount = incomeAmount * 0.1 + 40000000 * 0.2 +(incomeAmount - 50000000) * 0.3;
		}
	...
	return (
		<View style={styles.container}>
			...
			<TextInput style={styles.input} placeholder='Enter your income' keyboardType='numeric' value={income} onChangeText={(text)=> setIncome(text)}></TextInput>
